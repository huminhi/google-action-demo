...
Config.devPortSmartHome = "3030";
Config.smartHomeProviderGoogleClientId = process.env.GOOGLE_CLIENT_ID;
Config.smartHomeProvideGoogleClientSecret = process.env.GOOGLE_CLIENT_SECRET;
Config.smartHomeProviderApiKey = process.env.API_KEY;
...
function init() {
  ...
  if (!Config.smartHomeProviderCloudEndpoint)
    Config.smartHomeProviderCloudEndpoint = "http://localhost:3030";
